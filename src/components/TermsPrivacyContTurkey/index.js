      ...
      <TermsContInner>
        <TermsContWrap>
          ...
          <TermsContTop>
            ...
            <TermsContDesc>
              ...
              <TermsItemP>within the framework of the purpose for which they are required to be processed and as relevant, limited, and proportionate to such purpose, </TermsItemP>
              <TermsItemP>by preserving the accuracy and the most up-to-date state of such personal data as they have been provided to Samsung by you or otherwise,</TermsItemP>
              <TermsItemP>and by complying with the conditions stipulated in the KVKK.</TermsItemP>
              <div className='space'></div>
          ...
          <TermsContItem ref={el => (tocRef.current[5] = el)}>
            <TermsItemTitle>What are your rights under KVKK?</TermsItemTitle>
        ...
        <TermsContToc>
          <TermsTocInner>
            ...
            <TermsTocItem onClick={ ()=>{scrollHandler(tocRef.current[5])} } className={tocRef.current[5] === currentItem ? 'is-active' : ''}>What are your rights under KVKK?</TermsTocItem>
            ...
            <TermsTocItem onClick={ ()=>{scrollHandler(tocRef.current[9])} } className={tocRef.current[9] === currentItem ? 'is-active' : ''}>Contact Us</TermsTocItem>
          </TermsTocInner>
        </TermsContToc>
      </TermsContInner>
    </TermsContContainer>
