...
import { TermsContContainer, TermsContInner, TermsDropdownGroup, TermsContWrap, TermsContTop, TermsContTitle, TermsContVersion,TermsContDesc, TermsContLink, TermsContItem, TermsItemTitle, TermsItemP, TermsItemPtagTitle, TermsContListLoman, TermsContListNumber, TermsItemLink, TermsContToc, TermsTocInner, TermsTocItem, TermsTable } from '../TermsCont/TermsContElements';
      ...
      <TermsContInner>
        <TermsContWrap>
          ...
          <TermsContItem ref={el => (tocRef.current[10] = el)}>
            ...
            <br /><br />
            The easiest way to contact us is through our Privacy Support Page at <TermsItemLink href='https://www.samsung.com/request-desk.' target='_blank' rel='noopener noreferrer'>https://www.samsung.com/request-desk.</TermsItemLink><br />
            ...
            <br /><br />
            You can lodge a complaint with the relevant supervisory authority if you consider that our processing of your personal information infringes applicable law. Contact details for all EU supervisory authorities can be found at <TermsItemLink href='https://ec.europa.eu/newsroom/article29/item-detail.cfm?item_id=612080' target='_blank' rel='noopener noreferrer'>https://ec.europa.eu/newsroom/article29/item-detail.cfm?item_id=612080.</TermsItemLink>
          </TermsContItem>
