    ...
    <S.TermsContContainer>
      <S.TermsContInner>
        <S.TermsContWrap>
          ...
          <S.TermsContTop>
            <S.TermsContTitle>삼성개발자컨퍼런스 (SDC) 개인정보 처리방침</S.TermsContTitle>
          ...
          <S.TermsContItem ref={el => (tocRef.current[0] = el)}>
            <S.TermsItemTitle>1. 개인정보 수집 항목 및 방법</S.TermsItemTitle>
            <S.TermsItemSubTitle>(1) 개인정보 수집 항목</S.TermsItemSubTitle>
            ...
            <S.TermsItemSubTitle>(2) 개인정보 수집 방법</S.TermsItemSubTitle>
            삼성전자는 다음과 같이 개인정보를 수집합니다.
            <div className='space'></div>
            <S.TermsItemP>컨퍼런스 참여 등록 시 사용자가 직접 제공한 개인정보를 수집 </S.TermsItemP>
            <S.TermsItemP>서비스를 이용할 때 앱, 웹사이트 등에서 자동으로 생성된 정보(서비스 이용 기록 등)를 수집</S.TermsItemP>
            <S.TermsItemP>컨퍼런스 관련 상담 시 전화, 이메일, 상담게시판, 상담 메뉴 등을 통한 수집</S.TermsItemP>
            <S.TermsItemP>사용자가 참여한 이벤트, 프로모션 등을 통한 수집 </S.TermsItemP>
          </S.TermsContItem>

          <S.TermsContItem ref={el => (tocRef.current[1] = el)}>
            <S.TermsItemTitle>2. 개인정보 수집∙이용 목적</S.TermsItemTitle>
          ...
          <S.TermsContItem ref={el => (tocRef.current[2] = el)}>
            <S.TermsItemTitle>3. 개인정보 처리위탁</S.TermsItemTitle>
            ...
            <div className='space'></div>
            <S.TermsItemP>위탁된 업무 처리와 관계없는 개인정보 처리 금지 </S.TermsItemP>
            <S.TermsItemP>개인정보 보호를 위한 기술적∙관리적 조치 </S.TermsItemP>
            <S.TermsItemP>다른 업체로 재위탁 제한</S.TermsItemP>
            <S.TermsItemP>위탁업무 종료 후 개인정보 반환 또는 삭제 의무</S.TermsItemP>
            <S.TermsItemP>손해배상 등 책임에 관한 사항</S.TermsItemP>
          ...
          <S.TermsContItem ref={el => (tocRef.current[3] = el)}>
            <S.TermsItemTitle>4. 개인정보 삭제 </S.TermsItemTitle>
          ...
          <S.TermsContItem ref={el => (tocRef.current[4] = el)}>
            <S.TermsItemTitle>5. 사용자 및 법정대리인의 권리 및 행사 방법</S.TermsItemTitle>
            ...
            <div className='space'></div>
            <S.TermsItemP>대표전화(1588-4730) 이용 </S.TermsItemP>
            <S.TermsItemP>고객지원 담당부서 또는 개인정보 보호책임자에게 연락(다음 목차 참조) </S.TermsItemP>
          </S.TermsContItem>

          <S.TermsContItem ref={el => (tocRef.current[5] = el)}>
            <S.TermsItemTitle>6. 고객지원 담당부서 및 개인정보 보호책임자 </S.TermsItemTitle>
            ...
            <S.TermsItemSubTitle>(1) 고객지원 담당부서</S.TermsItemSubTitle>
            <div className='space'></div>
            <S.TermsItemP>고객지원 담당부서 : 삼성전자 글로벌마케팅센터 브랜드전략그룹</S.TermsItemP>
            <S.TermsItemP>문의처 :  <S.TermsItemLink href='mailto:sdcsupport@samsungdevelopers.com' target='_blank' rel='noopener noreferrer'>sdcsupport@samsungdevelopers.com</S.TermsItemLink></S.TermsItemP>

            <S.TermsItemSubTitle>(2) 개인정보 보호책임자 및 개인정보 보호 담당부서</S.TermsItemSubTitle>
            <div className='space'></div>
            <S.TermsItemP>개인정보 보호책임자 : 개인정보보호사무국장</S.TermsItemP>
            <S.TermsItemP>개인정보 보호 담당부서 : 개인정보보호사무국</S.TermsItemP>
            <S.TermsItemP>전화 : 1588-4730 </S.TermsItemP>
            <S.TermsItemP><S.TermsItemLink href='mailto:privacy.sec@samsung.com' target='_blank' rel='noopener noreferrer'>privacy.sec@samsung.com</S.TermsItemLink></S.TermsItemP>

            <S.TermsItemSubTitle>(3) 기타 기관</S.TermsItemSubTitle>
            <div className='space'></div>
            <S.TermsItemP>기타 개인정보 침해 신고나 상담이 필요한 경우에는 아래 기관에 문의해 주세요. </S.TermsItemP>
            <S.TermsItemP>개인정보침해 신고센터 (<S.TermsItemLink href='https://privacy.kisa.or.kr/' target='_blank' rel='noopener noreferrer'>privacy.kisa.or.kr</S.TermsItemLink> / 국번 없이 118)</S.TermsItemP>
            <S.TermsItemP>대검찰청 사이버수사과 (<S.TermsItemLink href='https://www.spo.go.kr/' target='_blank' rel='noopener noreferrer'>pwww.spo.go.kr</S.TermsItemLink> / 국번 없이 1301)</S.TermsItemP>
            <S.TermsItemP>경찰청 사이버수사국 (<S.TermsItemLink href='https://ecrm.police.go.kr/minwon/main' target='_blank' rel='noopener noreferrer'>ecrm.cyber.go.kr</S.TermsItemLink> / 국번 없이 182)</S.TermsItemP>
          </S.TermsContItem>

          <S.TermsContItem ref={el => (tocRef.current[6] = el)}>
            <S.TermsItemTitle>7. 개인정보 자동 수집 장치 설치, 운영, 거부에 관한 사항  </S.TermsItemTitle>
            ...
            <S.TermsItemSubTitle>(1) 쿠키 사용 목적</S.TermsItemSubTitle>
            삼성전자는 다음과 같은 목적으로 쿠키를 사용합니다.
            <div className='space'></div>
            <S.TermsItemP>자동 로그인 기능 구현</S.TermsItemP>
            <S.TermsItemP>회원/비회원의 접속 빈도 또는 방문 시간 등 분석</S.TermsItemP>
            <S.TermsItemP>사용자의 취향과 관심분야 파악 및 사용 기록 확인</S.TermsItemP>
            <S.TermsItemP>각종 이벤트 참여 및 방문 횟수 파악 등을 통한 타겟 마케팅과 개인 맞춤 서비스 제공 등</S.TermsItemP>

            <S.TermsItemSubTitle>(2) 쿠키 설정 방법</S.TermsItemSubTitle>
          ...
          <S.TermsContItem ref={el => (tocRef.current[7] = el)}>
            <S.TermsItemTitle>8. 안전한 개인정보 보호를 위한 조치</S.TermsItemTitle>
            삼성전자는 사용자의 개인정보를 안전하게 보호하기 위하여 다양한 보호조치와 노력을 하고 있습니다.
            <div className='space'></div>
            <S.TermsItemP>관리적 조치 : 내부 관리계획 수립 및 시행, 개인정보 교육 실시 등 </S.TermsItemP>
            <S.TermsItemP>기술적 조치 : 개인정보에 대한 접근통제 장치 운영 및 접근 권한 제한, 개인정보 처리시스템 접속기록 보관 및 위조/변조를 방지하기 위한 보안기능 사용, 개인정보의 암호화, 백신 프로그램 및 보안 프로그램 설치 등 </S.TermsItemP>
            <S.TermsItemP>물리적 조치 : 전산실, 자료보관실 등의 접근통제</S.TermsItemP>
          </S.TermsContItem>

          <S.TermsContItem ref={el => (tocRef.current[8] = el)}>
            <S.TermsItemTitle>9. 개인정보 처리방침 업데이트</S.TermsItemTitle>
        ...
        <S.TermsContToc>
          <S.TermsTocInner>
            <S.TermsTocItem onClick={ ()=>{scrollHandler(tocRef.current[0])} } className={tocRef.current[0] === currentItem ? 'is-active' : ''}>1. 개인정보 수집 항목 및 방법</S.TermsTocItem>
            <S.TermsTocItem onClick={ ()=>{scrollHandler(tocRef.current[1])} } className={tocRef.current[1] === currentItem ? 'is-active' : ''}>2. 개인정보 수집·이용 목적</S.TermsTocItem>
            <S.TermsTocItem onClick={ ()=>{scrollHandler(tocRef.current[2])} } className={tocRef.current[2] === currentItem ? 'is-active' : ''}>3. 개인정보 처리위탁</S.TermsTocItem>
            <S.TermsTocItem onClick={ ()=>{scrollHandler(tocRef.current[3])} } className={tocRef.current[3] === currentItem ? 'is-active' : ''}>4. 개인정보 삭제</S.TermsTocItem>
            <S.TermsTocItem onClick={ ()=>{scrollHandler(tocRef.current[4])} } className={tocRef.current[4] === currentItem ? 'is-active' : ''}>5. 사용자 및 법정대리인의 권리 및 행사 방법</S.TermsTocItem>
            <S.TermsTocItem onClick={ ()=>{scrollHandler(tocRef.current[5])} } className={tocRef.current[5] === currentItem ? 'is-active' : ''}>6. 고객지원 담당부서 및 개인정보 보호책임자</S.TermsTocItem>
            <S.TermsTocItem onClick={ ()=>{scrollHandler(tocRef.current[6])} } className={tocRef.current[6] === currentItem ? 'is-active' : ''}>7. 개인정보 자동 수집 장치 설치, 운영, 거부에 관한 사항</S.TermsTocItem>
            <S.TermsTocItem onClick={ ()=>{scrollHandler(tocRef.current[7])} } className={tocRef.current[7] === currentItem ? 'is-active' : ''}>8. 안전한 개인정보 보호를 위한 조치</S.TermsTocItem>
            <S.TermsTocItem onClick={ ()=>{scrollHandler(tocRef.current[8])} } className={tocRef.current[8] === currentItem ? 'is-active' : ''}>9. 개인정보 처리방침 업데이트</S.TermsTocItem>
          </S.TermsTocInner>
        </S.TermsContToc>
      </S.TermsContInner>
    </S.TermsContContainer>
