      ...
      <S.TermsContContainer>
        <S.CookieInner>
          <S.TermsContTop>
            ...
            <S.TermsContDesc><strong>Effective Date: <span className='date'>2022-09-21</span></strong></S.TermsContDesc>
            <br/>
            <S.TermsContDesc>
          ...
          <S.TermsContItem>
            ...
            <br/>
            <div className='space'></div>
            <S.TermsItemP>Cookies can remember your sign-in credentials so you don’t have to enter those credentials each time you log on to a service.</S.TermsItemP>
            <S.TermsItemP>Cookies help us and third parties understand which parts of our Services are the most popular because they help us to see which pages and features visitors are accessing and how much time they are spending on the pages. By studying this kind of information, we are better able to adapt the services on our website and provide you with a better experience.</S.TermsItemP>
            <S.TermsItemP>Cookies help us and third parties understand which ads you have seen so that we can tailor a more relevant communication and service to you.</S.TermsItemP>
            <S.TermsItemP>Cookies help us and third parties provide you with relevant content and advertising by collecting information about your use of our Services and other websites and apps.</S.TermsItemP>
            <div className='space'></div>
