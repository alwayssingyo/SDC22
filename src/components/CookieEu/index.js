...
import { TermsContContainer, CookieInner, TermsContTop, CookieTitle, TermsContDesc, TermsContItem, TermsItemTitle, TermsItemLink, TermsTable, TermsExtra } from '../TermsCont/TermsContElements';
      ...
      <TermsContContainer>
        <CookieInner>
          <TermsContTop>
            ...
            <TermsContDesc><strong>Updated on <span className='date'>2022-09-21</span></strong></TermsContDesc>
            <br/>
            <TermsContDesc>
          ...
          <TermsContItem>
            ...
            <TermsItemLink href='#;' rel='noopener noreferrer' onClick={function(e){
              ...
              setOpenManage(true);
              closePopup();
            }}>Cookies Management Tool</TermsItemLink>.
            <br/><br/>
            You can also update your browser settings at any time, if you want to remove or block cookies from your device (consult your browser's "help" menu to learn how to remove or block cookies). Samsung Electronics is not responsible for your browser settings. You can find good and simple instructions on how to manage cookies on the different types of web browsers at <TermsItemLink href='https://allaboutcookies.org/' target='_blank' rel='noopener noreferrer'>http://www.allaboutcookies.org</TermsItemLink>.
            <br/><br/>
